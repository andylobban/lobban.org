<?php get_header(); ?>
	...
	<section id="profiles" class="clearfix">
		...
		<ul>
    		...
    		<!--<li><a href="http://pinboard.in/u:nonimage" rel="me" class="url pinboard">Pinboard</a></li>-->
	...
	<!--<section id="contact">
		...
		<ul>
			<li><a type="text/directory" href="http://h2vx.com/vcf/lobban.org"><abbr title="Virtual Card">vCard</abbr></a> Download to address book</li>
